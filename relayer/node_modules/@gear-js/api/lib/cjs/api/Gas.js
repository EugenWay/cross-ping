...
class GearGas {
    ...
    async initUpload(sourceId, code, payload, value, allowOtherPanics, meta, typeIndexOrTypeName) {
        const method = this._api.specVersion > consts.SPEC_VERSION.V1200 ? 'calculateGasForUpload' : 'calculateInitUploadGas';
        return this._api.rpc.gear[method](sourceId, createPayload.encodePayload(code, undefined, undefined, 'Bytes'), createPayload.encodePayload(payload, meta, 'init', typeIndexOrTypeName), value || 0, allowOtherPanics || true);
    }
    /**
    ...
    async initCreate(sourceId, codeId, payload, value, allowOtherPanics, meta, typeIndexOrTypeName) {
        const method = this._api.specVersion > consts.SPEC_VERSION.V1200 ? 'calculateGasForCreate' : 'calculateInitCreateGas';
    ...
    async handle(sourceId, destinationId, payload, value, allowOtherPanics, meta, typeIndexOrTypeName) {
        const method = this._api.specVersion > consts.SPEC_VERSION.V1200 ? 'calculateGasForHandle' : 'calculateHandleGas';
    ...
    async reply(sourceId, messageId, payload, value, allowOtherPanics, meta, typeIndexOrTypeName) {
        const method = this._api.specVersion > consts.SPEC_VERSION.V1200 ? 'calculateGasForReply' : 'calculateReplyGas';
