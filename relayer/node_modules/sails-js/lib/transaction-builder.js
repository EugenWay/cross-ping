...
class TransactionBuilder {
    ...
    _gasInfo;
    programId;
    constructor(_api, _registry, extrinsic, payload, payloadType, _responseType, _programIdOrCodeOrCodeId, _onProgramCreated) {
        this._api = _api;
    ...
    async signAndSend() {
        ...
        return {
            ...
            response: async (rawResult = false) => {
                ...
                // prettier-ignore
                return this._registry.createType(`(String, String, ${this._responseType})`, payload)[2][getPayloadMethod(this._responseType)]();
            },
        };
    }
    get gasInfo() {
